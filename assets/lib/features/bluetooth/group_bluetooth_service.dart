...
class GroupBluetoothService {
  ...
  Future<void> _startAdvertising() async {
    try {
      ...
      // Démarrer l'annonce avec l'ID du groupe dans le nom
      ...
      _isAdvertising = true;
      print("Annonce démarrée avec l'ID: $_currentGroupId");
    } catch (e) {
      _eventController.add(GroupEvent(
  ...
  Future<void> _startScanning() async {
    ...
    try {
      ...
      // Démarrer un scan filtré sur notre UUID de service
